      ...
      <div class="modal-container bg-[#855B52]">
        ...
        <div class="modal-body text-white">
          ...
          <div v-show="event.fileAttachment !== null">
            <span class="text-lg font-sans italic"
              >You Have 1 File Attachment</span
            ><br />
            <a
              class="hover:cursor-pointer text-gray-300 font-bold underline hover:text-gray-700"
              :href="file"
              @click="download(event.fileAttachment)"
              download
              >Download</a
            >
          </div>
        ...
        <div class="text-black flex justify-end">
          <button
            class="ml-3 mb-4 border border-solid bg-white border-yellow-800 hover:bg-yellow-800 hover:text-black font-bold uppercase text-sm py-3 rounded outline-none focus:outline-none ease-linear transition-all duration-150 active show px-3"
